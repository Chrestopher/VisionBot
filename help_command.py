...
helppages= dict([(1,discord.Embed(title="Help Profile", colour=discord.Colour(int("FF0000", 16)))),
                ...
                (3, discord.Embed(title="Help page 3", colour=discord.Colour(int("FFDE00", 16))))])

#Help Page 1
helppages[1].set_footer(text="\t\t\t\t1/3")
helppages[1].add_field(name="profile create",value="Creates a new profile for you, with all categories filled as N/A",inline=False)
...
helppages[2].add_field(name="randpoke [generation]",value="Prints a random pokemon, and you may optionally include a "
                                                          "generation to pull a pokemon from a specific generation", inline=False)
